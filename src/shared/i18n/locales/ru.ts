...
export const ru: Messages = {
  ...
  'trend.legend.score': 'Средний балл (0–100)',
  'trend.a11y.volume':
    'График количества диалогов: {count} точек, максимум {max}.',
  'trend.a11y.score': 'График среднего балла: минимум {min}, максимум {max}.',
  'trend.a11y.scoreEmpty':
    'График среднего балла: за этот период не оценён ни один диалог.',
  ...
  'insights.busy':
    'ИИ сейчас занят — попробуйте через мгновение. Запрос был корректным.',
  'insights.caveat':
  ...
  'ask.busy':
    'ИИ сейчас занят. Вопрос корректный — нажмите «Спросить» ещё раз через мгновение.',
  'ask.evidence': 'Диалоги, на которые опирается ответ',
  'ask.clear': 'Очистить переписку',
  'ask.suggestion.1': 'Кто из сотрудников работает лучше всех?',
  'ask.suggestion.2': 'По какой причине чаще всего теряются продажи?',
  'ask.suggestion.3': 'Что стоит исправить в первую очередь за этот период?',
  'ask.scopeHint':
